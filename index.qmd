...
- Participants will work on [__SSPCloud__]{.orange} [[__link__]{.blue}](https://datalab.sspcloud.fr/);
- A support team will provide [__online support__]{.orange} over Zoom.

. . .

To participate you will need:

- a [__Github account__]{.blue};
- a [__SSPCloud account__]{.blue};
